...
const Granules = () => {
  ...
  const granules = [
    {
      id: 1,
      name: "LOVO Super",
      composition: "Chlorantraniliprole + Clothianidin 1.6% GR",
      crop: "Maize, Sugarcane, Rice",
      pest: "Leaf folder, Borers, Hoppers",
      dose: "6 kg",
  ...
  image: LovoImg,
    },
    {
      id: 2,
      name: "Apron",
      composition: "Chlorantraniliprole + Dinotefuran 0.12% GR",
      crop: "Rice, Maize, Sugarcane",
      pest: "Leaf folder, Fall Armyworm, Sugarcane Borers",
      dose: "8 kg",
      color: "from-green-500 to-green-600",
            ...
            {granules.map((granule) => (
              ...
              >
                ...
                <div
                  ...
                  onClick={() => {
                    setModalImg(granule.image);
                    setModalAlt(granule.name);
                    setZoom(1);
                    setModalOpen(true);
                  }}
                >
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="mb-3 sm:mb-4">
                    ...
                    <div
                      className={`h-1 w-16 bg-gradient-to-r ${granule.color} rounded-full`}
                    ></div>
                  </div>
